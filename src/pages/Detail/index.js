...
export default function Detail(){
    ...
    const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajuar no caso ${incident.title}, com o valor de ${Intl.NumberFormat('pt-BR', 
    ...
    return (
        <View style={styles.container}>
          ...
          <View style={styles.contactBox}>
              ...
              <Text style={styles.heroDesciption}>Entre em contato</Text>
